...
<div class="card mb-4">
  ...
  <div class="card-body">
    <form method="post" action="{{ route('admin.games.store') }}" class="row g-3" enctype="multipart/form-data">
      @csrf
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <input class="form-control" name="url" type="url" required maxlength="500">
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-3 form-check">
        <input class="form-check-input" type="checkbox" id="vpn" name="requires_vpn" value="1">
